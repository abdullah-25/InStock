    ...
    <li className="inventorylist__element">
      <div className="table-cell table-cell--first">
        ...
        <Link to={`/inventory/${id}`}>
          <p className="body-medium inventorylist__link">
            {item_name}
      ...
      <div
        className={`table-cell ${!displayWarehouseName && "table-cell--empty"}`}
      >
          ...
          <Modal open={open} onClose={handleClose} className="modal">
            <div className="modal-div">
              ...
              <p className="modal__text">
                Please confirm that you’d like to delete the {item_name} from
                the inventory. You won’t be able to undo this action.
              </p>
